...
// current store metadata (scrapers), calls the AI provider (OpenAI) for the
// requested type (copy | translation), and writes status/output via the
// service-role client. Screenshot generation is not implemented yet.
//
